...
document.querySelector("#movieSearch").addEventListener("click", function(event) {
  ...
  $(".content").empty();
    ...
    for (var i = 0; i < 5; i++) {
      ...
      $.ajax({
        url: `https://itunes.apple.com/search?term=${Title}+movie&country=us&limit=5`,
        method: "GET"
        ...
        $("#added-movie > tbody").prepend("<tr><td>"+ "<video src=" + newResults + " width=320 height=200 controls preload></video>"+ "</td><td>"+ description+"</td></tr>");
